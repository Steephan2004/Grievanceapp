...
#     client = Client(key='d8a9f1ba', secret='Wf40EKZx8gcb1pSV')
#     sms = Sms(client)

#     response = sms.send_message({
#         'from': 'Vonage APIs',# Replace 'YOUR_VIRTUAL_NUMBER' with your Vonage virtual number
#         'to': '916383765373',# Replace 'RECIPIENT_NUMBER' with the recipient's phone number
#         'text': 'Vanakam Da mapla ,Virudhunagar la irundhu',# Replace 'YOUR_MESSAGE' with the message you want to send
#     })

#     if response['messages'][0]['status'] == '0':
#         return JsonResponse({'status': 'success', 'message': 'SMS sent successfully'})
#     else:
#         return JsonResponse({'status': 'error', 'message': f'SMS failed with error: {response["messages"][0]["error-text"]}'})
...
def phone(MobileNumber):
    ...
    account_sid = 'AC9ab31fe06c1bc60efef0d1a2af1413f3'
    auth_token = '9d014a02a9bfc40c6895bfc735605de0'
...
def sendEmail(request):
  if request.method == 'GET':
    ...
    receiver_email = {
      'Computer': 'steephan85@gmail.com',
      'Civil': 'steephan383@gmail.com',
      'Electrical': 'steephan383@gmail.com',
      'Plumbing': 'gayagay265@gmail.com'
    }.get(Mail, 'steephan85@gmail.com')

    hod_email = {
      'CSE': 'steephan85@gmail.com',
      'EEE': 'steephan383@gmail.com',
      'ECE': 'steephan383@gmail.com',
      'MECH': 'gayathrigayathri3265@gmail.com',
      'NCC': 'steephan383@gmail.com',
      'HOSTEL': 'steephan383@gmail.com',
      'CANTEEN': 'gayathrigayathri3265@gmail.com',
    }.get(Venue, 'r\steephan85@gmail.com')

    # Add an additional email to the list
    additional_email = "steve03062004@gmail.com"
    ...
    password = 'afsbgcqpljc'  # Don't store passwords in plain text
